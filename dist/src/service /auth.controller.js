...
const decorators_1 = require("../dto/auth/decorators");
const req_context_decorator_1 = require("../dto/auth/decorators/req-context.decorator");
const request_context_dto_1 = require("../dto/auth/decorators/request-context.dto");
...
const sign_up_dto_1 = require("../dto/auth/dto/sign-up.dto");
const auth_guard_1 = require("../dto/auth/guards/auth.guard");
const jwt_refresh_guard_1 = require("../dto/auth/guards/jwt-refresh.guard");
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [sign_in_dto_1.forgetPassDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [sign_up_dto_1.confirmationInput]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "confirmForgetPassword", null);
__decorate([
    (0, common_1.UseGuards)(auth_guard_1.AuthenticationGuard),
    (0, swagger_1.ApiBearerAuth)(),
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [sign_up_dto_1.resetPassword]),
    __metadata("design:returntype", Promise)
